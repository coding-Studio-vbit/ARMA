...
function FacultyDashBoard() {
    ...
    function filterWithDates():EventInfo[]{
        let x= todaysEvents?.filter((element)=>
    ...
    async function fetchData(){
        setTimeout(() => {
            ...
            let li=[
                ...
                {
                    forum:"codingStudio();",event:"CodeCraft",date:{
                        day: 7,
                        month: 1,
                        year: 2022,
                    },
            ...
            <div className='mx-auto w-full px-4  md:px-8 lg:px-0 lg:w-10/12 flex flex-col justify-center items-center mt-10 gap-10 py-8 pb-14'>
                ...
                <div className='flex flex-row gap-y-10 flex-wrap  lg:flex-nowrap  justify-center lg:justify-start w-full md:w-5/6 lg:w-11/12  xl:w-9/12 gap-4 xl:gap-6'>
                    ...
                    <div className='w-full sm:w-2/3 lg:w-1/2 mx-4 px-10 py-12
                        ...
                        Today's Events - {selectedDate.day+"/"+selectedDate.month+"/"+selectedDate.year}</p>
                        {
                            selectedDate!=null &&
                            filterWithDates().length>0?
                            ...
                            <p className='text-xl text-teal-600 mt-4  my-auto h-full'>No Events Today</p>
                        }
                    </div>                    
