            ...
            <div className='flex flex-col items-center display:hidden'>            
                <div className='md:w-10/12 flex flex-col justify-start items-center mt-10 gap-10'>
                    ...
                    <div className='flex flex-row justify-around w-9/12 gap-10'>
                        ...
                        shadow-2xl rounded-2xl max-h-80 overflow-y-scroll currentRequest' >
                        ...
                        {/* New Requests */}
                        <div className='w-1/4 min-h-min p-20 shadow-2xl rounded-2xl text-center'>
                        ...
                        {/* Pending */}
                        <div className='w-1/4 min-h-min p-20 shadow-2xl rounded-2xl text-center py-auto'>
