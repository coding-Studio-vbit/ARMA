        ...
        <div className="my-8 ">
            ...
            <div className="mx-auto mt-12 w-[85%] sm:w-[70%] flex flex-col ">
                <div className="mb-8">
                    ...
                    <textarea className="bg-white border border-solid shadow-xl w-full min-h-max outline-none rounded-2xl border-white mt-3 p-6 h-fit text-xs md:text-sm" rows={5} value={desc} disabled={!isEdit} onChange={(e:any) => {setDesc(e.target.value)}}>
                    </textarea>
                </div>
                        ...
                        <div className="">
                            ...
                            <div className="flex p-5  text-xs md:text-sm  justify-center">
                                <div className="flex flex-col items-center gap-4 ">                    
                                    ...
                                    <label className={`rounded-[8px] hover:bg-slate-500/10 !cursor-pointer px-20 py-4 outline-dashed outline-gray-500 ${isEdit? "cursor-pointer" : "pointer-events-none"}`}>
