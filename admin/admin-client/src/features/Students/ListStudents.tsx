            ...
            <div className="flex flex-col">
                <div className="flex flex-col mt-5 sm:mx-5 mx-5 space-y-5">
                    ...
                    <Table
                        ...
                        headers={[
                            { displayName: "ROLL.NO", dataPath: "forum", sortable: false },
                            { displayName: "NAME", dataPath: "eventname", sortable: false },
                            { displayName: "YEAR", dataPath: "duration", sortable: false },
                            { displayName: "BRANCH", dataPath: "duration", sortable: false },
                            { displayName: "SECTION", dataPath: "duration", sortable: false },
